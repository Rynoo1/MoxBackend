...
namespace MoxBackEnd.Controllers
{
    ...
    public class TaskController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create([FromBody] DTOs.TaskCreateDto dto)
        {
            var task = new Tasks
            {
                Title = dto.Title,
        ...
        public async Task<IActionResult> UploadFile(int taskId, IFormFile file)
        {
            ...
            // Ensure FileUploads is initialized
            if (task.FileUploads == null)
                task.FileUploads = new List<FileUpload>();
        ...
        // Only update the status field of a task
        [HttpPut("{id}/status")]
